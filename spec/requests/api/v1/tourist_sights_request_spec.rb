...
RSpec.describe 'tourist sights API' do
  context 'GET "/api/v1/tourist_sights"' do
    it 'sends a collection of tourist sights' do
      ...
      stub_request(:get, "https://api.geoapify.com/v2/places?apiKey=8cb8b106c84c4e028afa60ec6c356327&categories=tourism.sights&filter=circle:2.0,46.0,20000&limit=500").
      with(
        headers: {
        'Accept'=>'*/*',
        'Accept-Encoding'=>'gzip;q=1.0,deflate;q=0.6,identity;q=0.3',
